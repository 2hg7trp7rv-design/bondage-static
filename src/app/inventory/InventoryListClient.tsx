        ...
        {filtered.map((car) => {
          ...
          return (
            <Link
              ...
              className="group rounded-2xl border border-neutral-800 bg-neutral-950/60 p-4 shadow-lg shadow-black/40 transition hover:-translate-y-1 hover:border-teal-400/80 hover:bg-neutral-900/80"
            >
